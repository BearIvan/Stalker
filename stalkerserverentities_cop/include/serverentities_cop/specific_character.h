...
protected:
	const SSpecificCharacterData* data					() const	{ DEBUGFATALERROR1(inherited_shared::get_sd()); return inherited_shared::get_sd();}
	SSpecificCharacterData*		  data					()			{ DEBUGFATALERROR1(inherited_shared::get_sd()); return inherited_shared::get_sd();}
