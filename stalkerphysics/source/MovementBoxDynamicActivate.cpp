...
bool ActivateBoxDynamic( IPHMovementControl* mov_control, bool character_exist,  DWORD id,  int num_it/*=8*/, int num_steps/*5*/, float resolve_depth/*=0.01f*/ )
{
	...
	DEBUGFATALERROR1( mov_control );
	DEBUGFATALERROR1( mov_control->character() );
...
//	float	resolve_depth=0.01f;
	...
	//const Fbox& box =Box();
	float pass=	character_exist ? XrMath::abs(mov_control->Box().getradius()-mov_control->Boxes()[id].getradius()) : mov_control->Boxes()[id].getradius();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
	for(int m=0;30>m;++m)
	{
		...
		//		m_character->Enable();
		//}
		DEBUGFATALERROR1(mov_control->character()->b_exist);
