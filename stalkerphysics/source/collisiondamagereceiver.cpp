...
void DamageReceiverCollisionCallback(bool& do_colide,bool bo1,dContact& c,SGameMtl* material_1,SGameMtl* material_2)
{
	...
	DEBUGFATALERROR12(dr,"wrong callback");
...
void BreakableObjectCollisionCallback(bool&/**do_colide/**/,bool bo1,dContact& c,SGameMtl * /*material_1*/,SGameMtl * /*material_2*/)
{
	...
	DEBUGFATALERROR1( usr_data_1 );
	DEBUGFATALERROR1( usr_data_2 );
	...
	if(bo1)
	{
		DEBUGFATALERROR1( usr_data_1->ph_ref_object );
...
/*
	...
	*/
	...
	//DEBUGFATALERROR1( this_object->m_pUnbrokenObject );
