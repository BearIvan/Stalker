...
public:
	...
	//! Computes magnitude
	IC	float		Magnitude()							const { return XrMath::sqrt(x*x + y * y + z * z); }
...
{
	float norm_box_proj = XrMath::abs(maxbox.x*normal.x) + XrMath::abs(maxbox.y*normal.y) + XrMath::abs(maxbox.z*normal.z);
