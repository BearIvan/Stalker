...
ContactCallbackFun				*default_character_contact_shotmark()						{ return m_default_character_contact_shotmark; }
	...
	CObjectSpace				&ObjectSpace					()							{ DEBUGFATALERROR1( m_object_space ); return *m_object_space; }
	CObjectList					&LevelObjects					()							{ DEBUGFATALERROR1( m_level_objects ); return *m_level_objects; }
	CRenderDeviceBase			&Device							()							{ DEBUGFATALERROR1( m_device ); return *m_device;	}
...
private:
	...
	void						set_update_callback				( IPHWorldUpdateCallbck* cb ){ DEBUGFATALERROR1( cb ); m_update_callback	= cb; }
