...
public:
	...
	virtual BoneCallbackFun* GetStaticObjectBonesCallback()	{ DEBUGFATALERROR1( false ); return StataticRootBonesCallBack; }
...
IC				CPHElement			&root_element					() { DEBUGFATALERROR1( !elements.empty() ); return *(*elements.begin()); }
	private:
