...
u16 NET_Compressor::compressed_size	(const bsize &count)
{
...
u16 NET_Compressor::Compress(BYTE* dest, const bsize &dest_size, BYTE* src, const bsize &count)
{
...
u16 NET_Compressor::Decompress	(BYTE* dest, const bsize &dest_size, BYTE* src, const bsize &count)
{
	VERIFY(dest);
	VERIFY(src);
	VERIFY(count);
