...
protected:
	...
	virtual void			_CollectBoneFaces	(Fvisual* V, bsize iBase,	bsize iCount);
			void			_EnumBoneVertices	( SEnumVerticesCallback &C, Fvisual* V, u16 bone_id, bsize iBase, bsize iCount ) const;
	...
	virtual void			_FillVertices		(const Fmatrix& view, CSkeletonWallmark& wm, const Fvector& normal, float size, Fvisual* V, u16 bone_id, bsize iBase, bsize iCount);
	...
	virtual BOOL			_PickBone			(IKinematics::pick_result &r, float range, const Fvector& S, const Fvector& D, Fvisual* V, u16 bone_id, bsize iBase, bsize iCount);
