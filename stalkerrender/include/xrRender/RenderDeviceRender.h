...
public:
	...
	virtual void	Reset( BearWindow&window/*, u32 &dwWidth, u32 &dwHeight, float &fWidth_2, float &fHeight_2*/) = 0;
	//	Init
	virtual void	SetupStates() = 0;
	virtual void	OnDeviceCreate(LPCSTR shName) = 0;
	virtual void	Create(BearWindow&window,bool /*, u32 &dwWidth, u32 &dwHeight, float &fWidth_2, float &fHeight_2, bool */) = 0;
