...
public:
	...
	virtual void	Reset( BearGraphics::BearWindow&window/*, u32 &dwWidth, u32 &dwHeight, float &fWidth_2, float &fHeight_2*/) = 0;
	//	Init
	virtual void	SetupStates() = 0;
	virtual void	OnDeviceCreate(LPCSTR shName) = 0;
	virtual void	Create(BearGraphics::BearWindow&window,bool /*, u32 &dwWidth, u32 &dwHeight, float &fWidth_2, float &fHeight_2, bool */) = 0;
	...
	virtual bsize		GetCacheStatPolys() = 0;
