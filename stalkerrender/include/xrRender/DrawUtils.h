...
public:
	...
	virtual void  DrawIndexedPrimitive	(int prim_type, bsize pc, const Fvector& pos, const Fvector* vb, const bsize& vb_size, const u32* ib, const bsize& ib_size, const u32& clr_argb, float scale=1.0f)=0;
