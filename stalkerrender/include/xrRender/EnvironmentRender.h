...
public:
	...
	virtual void OnDeviceCreate(EnvDescriptorRef *owner) = 0;
...
public:
	...
	virtual void OnFrame(EnvironmentRef *env) = 0;
	virtual void OnLoad() = 0;
	virtual void OnUnload() = 0;
	virtual void RenderSky(EnvironmentRef *env) = 0;
	virtual void RenderClouds(EnvironmentRef *env) = 0;
