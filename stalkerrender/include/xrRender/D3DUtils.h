...
public:
	...
	virtual void  DrawIndexedPrimitive	(int prim_type, bsize pc, const Fvector& pos, const Fvector* vb, const bsize& vb_size, const u32* ib, const bsize& ib_size, const u32& clr_argb, float scale=1.0f){};
    virtual void  DrawPrimitiveL(D3DPRIMITIVETYPE pt, bsize pc, Fvector* vertices, int vc, u32 color, BOOL bCull, BOOL bCycle);
    virtual void  DrawPrimitiveTL(D3DPRIMITIVETYPE pt, bsize pc, FVF::TL* vertices, int vc, BOOL bCull, BOOL bCycle);
    virtual void  DrawPrimitiveLIT(D3DPRIMITIVETYPE pt, bsize pc, FVF::LIT* vertices, int vc, BOOL bCull, BOOL bCycle);
