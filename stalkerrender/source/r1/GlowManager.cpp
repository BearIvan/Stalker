...
#define MAX_GlowsDist1		float(ENV.CurrentEnv->far_plane)
#define MAX_GlowsDist2		float(MAX_GlowsDist1*MAX_GlowsDist1)

#define MAX_GlowsDist1SOC		float(ENV_SOC.CurrentEnv.far_plane)
#define MAX_GlowsDist2SOC		float(MAX_GlowsDist1SOC*MAX_GlowsDist1SOC)
//////////////////////////////////////////////////////////////////////
...
void CGlowManager::add	(ref_glow G_)
{
	...
	if (gameVersionController->getGame() == gameVersionController->SOC)
		dlim2 = MAX_GlowsDist2SOC;
	else
		dlim2 = MAX_GlowsDist2;
