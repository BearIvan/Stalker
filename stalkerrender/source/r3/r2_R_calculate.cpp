...
void CRender::Calculate		()
{
	...
	r_ssaLOD_A						=	XrMath::sqr(ps_r2_ssaLOD_A/3)		/g_fSCREEN;
	r_ssaLOD_B						=	XrMath::sqr(ps_r2_ssaLOD_B/3)		/g_fSCREEN;
	...
	if (rmPortals) 
	{
		float	eps			= VIEWPORT_NEAR+XrMath::EPS_L;
	...
	g_SpatialSpace->q_sphere(lstRenderables,0,STYPE_LIGHTSOURCE,Device.vCameraPosition,XrMath::EPS_L);
