...
void dx10ShaderResourceStateCache::SetPSResource( u32 uiSlot, ID3DShaderResourceView	*pRes )
{
	...
	if ( m_PSViews[uiSlot] != pRes)
	{
		...
		if (m_bUpdatePSViews)
		{
			m_uiMinPSView = XrMath::min( m_uiMinPSView, uiSlot );
			m_uiMaxPSView = XrMath::max( m_uiMaxPSView, uiSlot );
		}
		else
		{
...
void dx10ShaderResourceStateCache::SetGSResource( u32 uiSlot, ID3DShaderResourceView	*pRes )
{
	...
	if ( m_GSViews[uiSlot] != pRes)
	{
		...
		if (m_bUpdateGSViews)
		{
			m_uiMinGSView = XrMath::min( m_uiMinGSView, uiSlot );
			m_uiMaxGSView = XrMath::max( m_uiMaxGSView, uiSlot );
		}
		else
		{
...
void dx10ShaderResourceStateCache::SetVSResource( u32 uiSlot, ID3DShaderResourceView	*pRes )
{
	...
	if ( m_VSViews[uiSlot] != pRes)
	{
		...
		if (m_bUpdateVSViews)
		{
			m_uiMinVSView = XrMath::min( m_uiMinVSView, uiSlot );
			m_uiMaxVSView = XrMath::max( m_uiMaxVSView, uiSlot );
		}
		else
		{
...
void dx10ShaderResourceStateCache::SetHSResource( u32 uiSlot, ID3DShaderResourceView	*pRes )
{
	...
	if ( m_HSViews[uiSlot] != pRes)
	{
		...
		if (m_bUpdateHSViews)
		{
			m_uiMinHSView = XrMath::min( m_uiMinHSView, uiSlot );
			m_uiMaxHSView = XrMath::max( m_uiMaxHSView, uiSlot );
		}
		else
		{
...
void dx10ShaderResourceStateCache::SetDSResource( u32 uiSlot, ID3DShaderResourceView	*pRes )
{
	...
	if ( m_DSViews[uiSlot] != pRes)
	{
		...
		if (m_bUpdateDSViews)
		{
			m_uiMinDSView = XrMath::min( m_uiMinDSView, uiSlot );
			m_uiMaxDSView = XrMath::max( m_uiMaxDSView, uiSlot );
		}
		else
		{
...
void dx10ShaderResourceStateCache::SetCSResource( u32 uiSlot, ID3DShaderResourceView	*pRes )
{
	...
	if ( m_CSViews[uiSlot] != pRes)
	{
		...
		if (m_bUpdateCSViews)
		{
			m_uiMinCSView = XrMath::min( m_uiMinCSView, uiSlot );
			m_uiMaxCSView = XrMath::max( m_uiMaxCSView, uiSlot );
		}
		else
		{
