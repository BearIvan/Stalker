...
void XRaySkeletonXExt::_CollectBoneFaces(XRayFVisual* V, bsize OffsetIndex, bsize CountIndex)
{
	u16* indices = 0;
...
BOOL XRaySkeletonXExt::_PickBone(IKinematics::pick_result& r, float dist, const Fvector& start, const Fvector& dir, XRayFVisual* V, u16 bone_id, bsize OffsetIndex, bsize CountIndex)
{
...
void XRaySkeletonXExt::_EnumBoneVertices(SEnumVerticesCallback& C, XRayFVisual* V, u16 bone_id, bsize OffsetIndex, bsize CountIndex) const
{
