#pragma once
class BearDUInterface:public CDUInterface
{
public:
	BearDUInterface();
	//----------------------------------------------------
	...
	virtual void __stdcall DrawFaceNormal(const Fvector* p, float size, u32 clr);
	virtual void __stdcall DrawFaceNormal(const Fvector& C, const Fvector& N, float size, u32 clr);
