...
private:
	BearGraphics::BearVertexBufferRef m_TL_buffer;
	BearGraphics::BearVertexBufferRef m_LIT_buffer;
	BearGraphics::BearIndexBufferRef m_IndexBuffer;
	bsize m_IndexCount;
	ePrimitiveType	m_PrimitiveType;
	ePointType		m_PointType;

	bsize				m_TL_iMaxVerts;
	bsize				m_LIT_iMaxVerts;
