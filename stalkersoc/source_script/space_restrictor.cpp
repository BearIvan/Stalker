...
// check if the object in sight
		...
		if(z){
			string64 str;
			switch (z->ZoneState()){
				case CCustomZone::eZoneStateIdle:		BearString::Copy(str,"IDLE"); break;
				case CCustomZone::eZoneStateAwaking:	BearString::Copy(str,"AWAKING"); break;
				case CCustomZone::eZoneStateBlowout:	BearString::Copy(str,"BLOWOUT"); break;
				case CCustomZone::eZoneStateAccumulate: BearString::Copy(str,"ACCUMULATE"); break;
				case CCustomZone::eZoneStateDisabled:	BearString::Copy(str,"DISABLED"); break;
			};
