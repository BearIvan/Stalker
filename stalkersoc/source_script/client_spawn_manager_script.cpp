...
void CClientSpawnManager::script_register(lua_State *L)
{
	...
	[
		class_<CClientSpawnManager>("client_spawn_manager")
			.def("add",		(void (CClientSpawnManager::*)(ALife::_OBJECT_ID,ALife::_OBJECT_ID,const luabind::object&, const luabind::object &))(&CClientSpawnManager::add))
			.def("add",		(void (CClientSpawnManager::*)(ALife::_OBJECT_ID,ALife::_OBJECT_ID,const luabind::object&))(&CClientSpawnManager::add))
