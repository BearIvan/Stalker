...
public:
	...
	{
		pWallmarkShader=const_cast< wm_shader&>(s);
		pos.set(p);
		T=Tri;
	}
	virtual void 			run								()
...
void  TContactShotMark(CDB::TRI* T,dContactGeom* c)
{
	...
	dReal vel_cret=dFabs(dDOT(vel,c->normal))* XrMath::sqrt(m.mass);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			{
				if(vel_cret>Pars::vel_cret_particles && !mtl_pair->m_pCollideMarks->empty())
				{
					SGameMtl* static_mtl = GMLib.GetMaterialByIdx(T->material);
					VERIFY(static_mtl);
