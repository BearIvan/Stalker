...
void CObjectHandlerPlanner::set_goal	(MonsterSpace::EObjectAction object_action, CGameObject *game_object, u32 min_queue_size, u32 max_queue_size, u32 min_queue_interval, u32 max_queue_interval)
{
		...
		)
	{
		...
		if (m_max_queue_size == m_min_queue_size)
			...
			m_queue_size		= XrMath::max(s32(1),::Random.randI(m_min_queue_size,m_max_queue_size));
...
IC const bchar*xr_strcat(bchar*S, const  bchar*DST)
{
	BearCore::BearString::Contact(S, 64, DST);
	return S;
}
#ifdef LOG_ACTION
LPCSTR CObjectHandlerPlanner::action2string(const _action_id_type &id)
{
	...
	if (action_object_id(id) != 0xffff)
		if (Level().Objects.net_Find(static_cast<u16>(action_object_id(id))))
			BearCore::BearString::Copy	(S,64,*Level().Objects.net_Find(static_cast<u16>(action_object_id(id)))->cName());
		else
			BearCore::BearString::Copy	(S,64,"no_items");
	else
		BearCore::BearString::Copy	(S,64,"no_items");
	xr_strcat		(S,":");
	
	switch (action_state_id(id)) {
		case ObjectHandlerSpace::eWorldOperatorShow			: {xr_strcat(S,"Show");					break;}
		case ObjectHandlerSpace::eWorldOperatorHide			: {xr_strcat(S,"Hide");					break;}
		case ObjectHandlerSpace::eWorldOperatorDrop			: {xr_strcat(S,"Drop");					break;}
		case ObjectHandlerSpace::eWorldOperatorStrapping	: {xr_strcat(S,"Strapping");				break;}
		case ObjectHandlerSpace::eWorldOperatorStrapping2Idle: {xr_strcat(S,"Strapping to idle");		break;}
		case ObjectHandlerSpace::eWorldOperatorUnstrapping	: {xr_strcat(S,"Unstrapping");				break;}
		case ObjectHandlerSpace::eWorldOperatorUnstrapping2Idle: {xr_strcat(S,"Unstrapping to idle");	break;}
		case ObjectHandlerSpace::eWorldOperatorStrapped		: {xr_strcat(S,"StrappedIdle");			break;}
		case ObjectHandlerSpace::eWorldOperatorIdle			: {xr_strcat(S,"Idle");					break;}
		case ObjectHandlerSpace::eWorldOperatorAim1			: {xr_strcat(S,"Aim1");					break;}
		case ObjectHandlerSpace::eWorldOperatorAim2			: {xr_strcat(S,"Aim2");					break;}
		case ObjectHandlerSpace::eWorldOperatorReload1		: {xr_strcat(S,"Reload1");					break;}
		case ObjectHandlerSpace::eWorldOperatorReload2		: {xr_strcat(S,"Reload2");					break;}
		case ObjectHandlerSpace::eWorldOperatorForceReload1	: {xr_strcat(S,"Force Reload1");			break;}
		case ObjectHandlerSpace::eWorldOperatorForceReload2	: {xr_strcat(S,"Force Reload2");			break;}
		case ObjectHandlerSpace::eWorldOperatorFire1		: {xr_strcat(S,"Fire1");					break;}
		case ObjectHandlerSpace::eWorldOperatorFire2		: {xr_strcat(S,"Fire2");					break;}
		case ObjectHandlerSpace::eWorldOperatorAimingReady1	: {xr_strcat(S,"AimingReady1");			break;}
		case ObjectHandlerSpace::eWorldOperatorAimingReady2	: {xr_strcat(S,"AimingReady2");			break;}
		case ObjectHandlerSpace::eWorldOperatorSwitch1		: {xr_strcat(S,"Switch1");					break;}
		case ObjectHandlerSpace::eWorldOperatorSwitch2		: {xr_strcat(S,"Switch2");					break;}
		case ObjectHandlerSpace::eWorldOperatorQueueWait1	: {xr_strcat(S,"QueueWait1");				break;}
		case ObjectHandlerSpace::eWorldOperatorQueueWait2	: {xr_strcat(S,"QueueWait1");				break;}
		case ObjectHandlerSpace::eWorldOperatorThrowStart	: {xr_strcat(S,"ThrowStart");				break;}
		case ObjectHandlerSpace::eWorldOperatorThrowIdle	: {xr_strcat(S,"ThrowIdle");				break;}
		case ObjectHandlerSpace::eWorldOperatorThrow		: {xr_strcat(S,"Throwing");				break;}
		case ObjectHandlerSpace::eWorldOperatorThreaten		: {xr_strcat(S,"Threaten");				break;}
		case ObjectHandlerSpace::eWorldOperatorPrepare		: {xr_strcat(S,"Preparing");				break;}
		case ObjectHandlerSpace::eWorldOperatorUse			: {xr_strcat(S,"Using");					break;}
		case ObjectHandlerSpace::eWorldOperatorGetAmmo1		: {xr_strcat(S,"GetAmmo1");				break;}
		case ObjectHandlerSpace::eWorldOperatorGetAmmo2		: {xr_strcat(S,"GetAmmo2");				break;}
		case ObjectHandlerSpace::eWorldOperatorAimForceFull1: {xr_strcat(S,"AimForceFull1");			break;}
		case ObjectHandlerSpace::eWorldOperatorAimForceFull2: {xr_strcat(S,"AimForceFull2");			break;}
		default												: NODEFAULT;
	}
	return		(S);
}
...
LPCSTR CObjectHandlerPlanner::property2string(const _condition_type &id)
{
	...
	xr_strcat		(S,":");
	switch (action_state_id(id)) {
		case ObjectHandlerSpace::eWorldPropertyHidden		: {xr_strcat(S,"Hidden");				break;}
		case ObjectHandlerSpace::eWorldPropertyStrapped		: {xr_strcat(S,"Strapped");			break;}
		case ObjectHandlerSpace::eWorldPropertyStrapped2Idle: {xr_strcat(S,"Strapped to idle");	break;}
		case ObjectHandlerSpace::eWorldPropertySwitch1		: {xr_strcat(S,"Switch1");				break;}
		case ObjectHandlerSpace::eWorldPropertySwitch2		: {xr_strcat(S,"Switch2");				break;}
		case ObjectHandlerSpace::eWorldPropertyAimed1		: {xr_strcat(S,"Aimed1");				break;}
		case ObjectHandlerSpace::eWorldPropertyAimed2		: {xr_strcat(S,"Aimed2");				break;}
		case ObjectHandlerSpace::eWorldPropertyAimForceFull1: {xr_strcat(S,"AimedForceFull1");		break;}
		case ObjectHandlerSpace::eWorldPropertyAimForceFull2: {xr_strcat(S,"AimedForceFull2");		break;}
		case ObjectHandlerSpace::eWorldPropertyAiming1		: {xr_strcat(S,"Aiming1");				break;}
		case ObjectHandlerSpace::eWorldPropertyAiming2		: {xr_strcat(S,"Aiming2");				break;}
		case ObjectHandlerSpace::eWorldPropertyEmpty1		: {xr_strcat(S,"Empty1");				break;}
		case ObjectHandlerSpace::eWorldPropertyEmpty2		: {xr_strcat(S,"Empty2");				break;}
		case ObjectHandlerSpace::eWorldPropertyFull1		: {xr_strcat(S,"Full1");				break;}
		case ObjectHandlerSpace::eWorldPropertyFull2		: {xr_strcat(S,"Full2");				break;}
		case ObjectHandlerSpace::eWorldPropertyReady1		: {xr_strcat(S,"Ready1");				break;}
		case ObjectHandlerSpace::eWorldPropertyReady2		: {xr_strcat(S,"Ready2");				break;}
		case ObjectHandlerSpace::eWorldPropertyFiring1		: {xr_strcat(S,"Firing1");				break;}
		case ObjectHandlerSpace::eWorldPropertyFiring2		: {xr_strcat(S,"Firing2");				break;}
		case ObjectHandlerSpace::eWorldPropertyAimingReady1	: {xr_strcat(S,"AimingReady1");		break;}
		case ObjectHandlerSpace::eWorldPropertyAimingReady2	: {xr_strcat(S,"AimingReady2");		break;}
		case ObjectHandlerSpace::eWorldPropertyAmmo1		: {xr_strcat(S,"Ammo1");				break;}
		case ObjectHandlerSpace::eWorldPropertyAmmo2		: {xr_strcat(S,"Ammo2");				break;}
		case ObjectHandlerSpace::eWorldPropertyIdle			: {xr_strcat(S,"Idle");				break;}
		case ObjectHandlerSpace::eWorldPropertyIdleStrap	: {xr_strcat(S,"IdleStrap");			break;}
		case ObjectHandlerSpace::eWorldPropertyDropped		: {xr_strcat(S,"Dropped");				break;}
		case ObjectHandlerSpace::eWorldPropertyQueueWait1	: {xr_strcat(S,"QueueWait1");			break;}
		case ObjectHandlerSpace::eWorldPropertyQueueWait2	: {xr_strcat(S,"QueueWait2");			break;}
		case ObjectHandlerSpace::eWorldPropertyThrowStarted	: {xr_strcat(S,"ThrowStarted");		break;}
		case ObjectHandlerSpace::eWorldPropertyThrowIdle	: {xr_strcat(S,"ThrowIdle");			break;}
		case ObjectHandlerSpace::eWorldPropertyThrow		: {xr_strcat(S,"Throwing");			break;}
		case ObjectHandlerSpace::eWorldPropertyThreaten		: {xr_strcat(S,"Threaten");			break;}
		case ObjectHandlerSpace::eWorldPropertyPrepared		: {xr_strcat(S,"Prepared");			break;}
		case ObjectHandlerSpace::eWorldPropertyUsed			: {xr_strcat(S,"Used");				break;}
		case ObjectHandlerSpace::eWorldPropertyUseEnough	: {xr_strcat(S,"UseEnough");			break;}
