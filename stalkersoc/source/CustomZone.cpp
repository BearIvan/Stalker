...
void CCustomZone::UpdateIdleLight	()
{
	...
	Fcolor					fclr;
	fclr.set				((float)XrColor::color_get_B(clr)/255.f,(float)XrColor::color_get_G(clr)/255.f,(float)XrColor::color_get_R(clr)/255.f,1.f);
...
void CCustomZone::StopWind()
{
	...
	m_bBlowoutWindActive = false;
	ENV_SOC.wind_strength_factor = m_fStoreWindPower;
}
