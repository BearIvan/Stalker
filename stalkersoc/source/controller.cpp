...
#include "ai/monsters/controller/controller_state_manager.h"
...
#include "ai/monsters/controller/controller_psy_aura.h"
...
//	m_UIControlFX2.Init(pSettings->r_string(section, "control_fx_texture2"), "hud\\default",0,0,0);
	...
	BearCore::BearString::Scanf(pSettings->r_string(ppi_section,"color_base"),	"%f,%f,%f", &m_control_effector.ppi.color_base.r,	&m_control_effector.ppi.color_base.g,	&m_control_effector.ppi.color_base.b);
	BearCore::BearString::Scanf(pSettings->r_string(ppi_section,"color_gray"),	"%f,%f,%f", &m_control_effector.ppi.color_gray.r,	&m_control_effector.ppi.color_gray.g,	&m_control_effector.ppi.color_gray.b);
	BearCore::BearString::Scanf(pSettings->r_string(ppi_section,"color_add"),	"%f,%f,%f", &m_control_effector.ppi.color_add.r,	&m_control_effector.ppi.color_add.g,	&m_control_effector.ppi.color_add.b);
...
bool CController::can_psy_fire()
{
	...
	if (XrMath::angle_difference(cur_yaw,dir_yaw) > _pmt_psy_attack_min_angle) return false;
