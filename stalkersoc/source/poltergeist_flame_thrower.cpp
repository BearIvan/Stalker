...
void CPolterFlame::load(LPCSTR section) 
{
	...
	BearString::Scanf(pSettings->r_string(ppi_section,"color_base"),	"%f,%f,%f", &m_scan_effector_info.color_base.r,	&m_scan_effector_info.color_base.g,	&m_scan_effector_info.color_base.b);
	BearString::Scanf(pSettings->r_string(ppi_section,"color_gray"),	"%f,%f,%f", &m_scan_effector_info.color_gray.r,	&m_scan_effector_info.color_gray.g,	&m_scan_effector_info.color_gray.b);
	BearString::Scanf(pSettings->r_string(ppi_section,"color_add"),	"%f,%f,%f", &m_scan_effector_info.color_add.r,	&m_scan_effector_info.color_add.g,	&m_scan_effector_info.color_add.b);
