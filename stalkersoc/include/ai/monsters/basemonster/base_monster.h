...
public:
	...
	virtual void			LookPosition					(Fvector to_point, float angular_speed = XrMath::PI_DIV_3);		// каждый монстр может по-разному реализвать эту функ (e.g. кровосос с поворотом головы и т.п.)
