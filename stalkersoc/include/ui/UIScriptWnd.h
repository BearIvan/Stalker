...
public:
	...
	virtual						~CUIDialogWndEx		();
			void				AddCallback			(LPCSTR control_id, s16 event, const luabind::object &lua_function);
			void				AddCallback			(LPCSTR control_id, s16 event, const luabind::object &functor, const luabind::object &object);
	virtual void				Update				();
