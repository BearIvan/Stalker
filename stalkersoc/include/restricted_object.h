...
protected:
	...
	IC		void			construct_restriction_string	(LPSTR temp_restrictions, const bsize size, const xr_vector<ALife::_OBJECT_ID> &restrictions, shared_str current_restrictions, const P &p);
