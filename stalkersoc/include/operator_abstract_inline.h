...
TEMPLATE_SPECIALIZATION
IC	bool CAbstractOperator::apply_reverse	(const CSConditionState &condition, const CSConditionState &start, CSConditionState &result1, const CSConditionState &self_condition) const
{
	result1.clear			();
	bool					changed = false;
	xr_vector<COperatorCondition>::const_iterator	i = self_condition.conditions().begin();
...
TEMPLATE_SPECIALIZATION
IC	const typename CAbstractOperator::CSConditionState &CAbstractOperator::apply	(const CSConditionState &condition, const CSConditionState &self_condition, CSConditionState &result1) const
{
	result1.clear			();
	xr_vector<COperatorCondition>::const_iterator	i = self_condition.conditions().begin();
	xr_vector<COperatorCondition>::const_iterator	e = self_condition.conditions().end();
