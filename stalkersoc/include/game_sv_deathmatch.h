...
class	game_sv_Deathmatch			: public game_sv_mp,private pure_relcase
{
	...
	void GetWinningPlayerFunctor(IClient * client);
	u32 GetWinningPlayerFunctorFlags;
	game_PlayerState*GetWinningPlayerFunctorWinner;
	void OnRoundStartFunctor(IClient * client);
protected:
	struct		RPointData
	{
		u32		PointID;
