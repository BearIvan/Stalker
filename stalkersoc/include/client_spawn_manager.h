...
public:
	typedef XrFastDelegate<void,CObject*>			CALLBACK_TYPE;
...
public:
	...
	virtual				~CClientSpawnManager	();
			void		add						(ALife::_OBJECT_ID	requesting_id, ALife::_OBJECT_ID requested_id, const luabind::object&functor, const luabind::object &object);
			void		add						(ALife::_OBJECT_ID	requesting_id, ALife::_OBJECT_ID requested_id, const luabind::object &lua_function);
