...
protected:
	const SCharacterProfile*	data				() const	{ DEBUGFATALERROR1(inherited_shared::get_sd()); return inherited_shared::get_sd();}
	SCharacterProfile*			data				()				{ DEBUGFATALERROR1(inherited_shared::get_sd()); return inherited_shared::get_sd();}
