...
typedef XrFastDelegate<void,sending_status_t, u32, u32> sending_state_callback_t;
typedef XrFastDelegate<void,receiving_status_t, u32, u32> receiving_state_callback_t;
