...
public:
	...
	IC		CALifeMonsterBrain		&brain					() const {DEBUGFATALERROR1(m_brain); return(*m_brain);}
...
public:
	...
	virtual bool					natural_weapon			() const {return false;}
	virtual bool					natural_detector		() const {return false;}
	IC		CALifeHumanBrain		&brain					() const {DEBUGFATALERROR1(m_brain); return(*m_brain);}
	virtual CALifeMonsterBrain		*create_brain			();
...
public:
	IC		CALifeOnlineOfflineGroupBrain	&brain	() const {DEBUGFATALERROR1(m_brain); return(*m_brain);}
