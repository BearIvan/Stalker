...
void CUIDoubleProgressBar::InitFromXml( CUIXml& xml_doc, LPCSTR path )
{
	...
	m_less_color = CUIXmlInit::GetColor( xml_doc, buf, 0, XrColor::XrColor::color_rgba( 255,   0, 0, 255 ) );
	strconcat( sizeof(buf), buf, path, ":color_more" );
	m_more_color = CUIXmlInit::GetColor( xml_doc, buf, 0, XrColor::XrColor::color_rgba(   0, 255, 0, 255 ) );
