...
#include "actor.h"
#include "ai/monsters/burer/burer_state_manager.h"
...
#include "ai/monsters/burer/burer_fast_gravi.h"
...
void CBurer::UpdateGraviObject()
{
	...
	for (u32 i=0;i<m_nearest.size();i++) {
		...
		Fvector dir1;
		dir1.sub(obj->Position(), m_gravi_object.cur_pos);
		dir1.normalize();
		obj->m_pPhysicsShell->applyImpulse(dir1,m_gravi.impulse_to_objects * obj->m_pPhysicsShell->getMass());
	}
