...
void CSE_Visual::FillProps		(LPCSTR pref, PropItemVec &items)
{
	...
	V->OnChangeEvent. = V->OnChangeEvent.bind		(this,&CSE_Visual::OnChangeVisual);
	...
	V->OnChangeEvent. = V->OnChangeEvent.bind		(this,&CSE_Visual::OnChangeAnim);
...
void CSE_Motion::FillProps(		LPCSTR pref, PropItemVec &items)
{
	...
	V->OnChangeEvent = V->OnChangeEvent.bind		(this,&CSE_Motion::OnChangeMotion);
}
#endif // #ifndef XRGAME_EXPORTS
