...
public:
	...
	bsize									GetNearest			( xr_vector<CObject*>&	q_nearest, ICollisionForm *obj, float range );
	bsize									GetNearest			( xr_vector<CObject*>&	q_nearest, const Fvector &point, float range, CObject* ignore_object );
	bsize									GetNearest			( xr_vector<ISpatial*>& q_spatial, xr_vector<CObject*>&	q_nearest, const Fvector &point, float range, CObject* ignore_object );
