...
public:
    ...
    xr_vector <XrFastDelegate<void> > seqParallel;
...
public:
    ...
    ICF void remove_from_seq_parallel(const XrFastDelegate<void>& delegate)
    {
        xr_vector<XrFastDelegate<void>  >::iterator I = std::find(
                    seqParallel.begin(),
                    seqParallel.end(),
                    delegate
                );
...
typedef XrFastDelegate<bool> LOADING_EVENT;
