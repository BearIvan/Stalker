...
public:
    ...
    IC SItem_ServerInfo& operator[] (bsize id) { VERIFY(id < max_item); return data[id]; }
...
public:
    ...
    virtual void Load_GameSpecific_CFORM(CDB::TRI* T, bsize count) = 0;
