...
#define ENV (*dynamic_cast<CEnvironment*>(g_pGamePersistent->Environment()))
// t-defs
...
class ENGINE_API CEnvDescriptor:public EnvDescriptorRef
{
public:
    float exec_time;
...
class ENGINE_API CEnvironment:public EnvironmentRef
{
