...
#define VIRT_MESSAGE_SIZE 512
	...
	if (!LoadString(hApp, NULL, pszError, VIRT_ERROR_SIZE))
        return 0;

	if (!LoadString(hApp, NULL, pszMessage, VIRT_MESSAGE_SIZE))
        return 0;
...
#undef FS
	...
	BEAR_ERRORMESSAGE(GFS->LoadFromFile(FSFilePath, BearEncoding::UTF8), TEXT("��������� ��������� %s"), TEXT("stalker.fs"));
#define FS (*GFS)
