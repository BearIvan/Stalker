...
void line_edit_control::add_inserted_text()
{
    ...
    PSTR buf = (PSTR)malloc((m_buffer_size + 1) * sizeof(char));
...
void remove_spaces(PSTR str1) // in & out
{
	...
	memcpy(new_str, str2, str_size - (str2 - str1));
	PSTR str3 = new_str + str_size - (str2 - str1) - 1;
	for (; str3 != new_str&&*str3 == ' '; str3--);
	memcpy(str1, new_str, str3 - new_str + 1);
	str1[str3 - new_str + 1] = 0;
	free(new_str);
}
