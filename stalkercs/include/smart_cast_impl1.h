...
IC	T1	smart_cast(T2* p)
{
	...
	STATIC_CHECK(object_type_traits::is_void<object_type_traits::remove_pointer<T1>::type>::value || xr_is_polymorphic<object_type_traits::remove_pointer<T1>::type>::value , Invalid_target_type_for_Dynamic_Cast);
