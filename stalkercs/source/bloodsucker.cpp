...
#include "ai/monsters/bloodsucker/bloodsucker_state_manager.h"
#include "actor.h"
...
void CAI_Bloodsucker::LoadVampirePPEffector(LPCSTR section)
{
	...
	BearString::Scanf(pSettings->r_string(section,"color_base"),	"%f,%f,%f", &pp_vampire_effector.color_base.r, &pp_vampire_effector.color_base.g, &pp_vampire_effector.color_base.b);
	BearString::Scanf(pSettings->r_string(section,"color_gray"),	"%f,%f,%f", &pp_vampire_effector.color_gray.r, &pp_vampire_effector.color_gray.g, &pp_vampire_effector.color_gray.b);
	BearString::Scanf(pSettings->r_string(section,"color_add"),	"%f,%f,%f", &pp_vampire_effector.color_add.r,  &pp_vampire_effector.color_add.g,  &pp_vampire_effector.color_add.b);
}
...
void CAI_Bloodsucker::apply_actor_camera_effector()
{
	...
	const TTime current_tick   = XrMath::min(time(), m_camera_effector_start_move_tick + 
	...
	Actor()->cam_Active()->Move(m_camera_effector_hor_angle > 0 ? kRIGHT : kLEFT, 
		                        XrMath::abs(m_camera_effector_hor_angle)*angle_relative);

	Actor()->cam_Active()->Move(m_camera_effector_ver_angle > 0 ? kUP	 : kDOWN, 
		                        XrMath::abs(m_camera_effector_ver_angle)*angle_relative);
}
