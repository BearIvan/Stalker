...
u32 CTeamInfo::GetTeam1_color(){
	...
	team1_color = XrColor::color_argb(155,atoi(XrTrims::GetItem(tm_col, 0, _buff)),atoi(XrTrims::GetItem(tm_col, 1, _buff)),atoi(XrTrims::GetItem(tm_col, 2, _buff)));
...
u32 CTeamInfo::GetTeam2_color(){
	...
	team2_color = XrColor::color_argb(155,atoi(XrTrims::GetItem(tm_col, 0, _buff)),atoi(XrTrims::GetItem(tm_col, 1, _buff)),atoi(XrTrims::GetItem(tm_col, 2, _buff)));
